...
enum [[deprecated]] : int {
    ...
    SBK_QRHID3D11INITPARAMS_IDX                              = 586,
    SBK_QRHID3D11NATIVEHANDLES_IDX                           = 588,
    SBK_QRHID3D12INITPARAMS_IDX                              = 590,
    SBK_QRHID3D12NATIVEHANDLES_IDX                           = 592,
    SBK_QRHIDEPTHSTENCILCLEARVALUE_IDX                       = 594,
    SBK_QRHIDRIVERINFO_DEVICETYPE_IDX                        = 598,
    SBK_QRHIDRIVERINFO_IDX                                   = 596,
    SBK_QRHIGLES2INITPARAMS_IDX                              = 600,
    SBK_QRHIGLES2NATIVEHANDLES_IDX                           = 602,
    SBK_QRHIGRAPHICSPIPELINE_FLAG_IDX                        = 616,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_FLAG_IDX                 = 200,
    SBK_QRHIGRAPHICSPIPELINE_TOPOLOGY_IDX                    = 628,
    SBK_QRHIGRAPHICSPIPELINE_CULLMODE_IDX                    = 614,
    SBK_QRHIGRAPHICSPIPELINE_FRONTFACE_IDX                   = 618,
    SBK_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX          = 610,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX   = 198,
    SBK_QRHIGRAPHICSPIPELINE_BLENDFACTOR_IDX                 = 606,
    SBK_QRHIGRAPHICSPIPELINE_BLENDOP_IDX                     = 608,
    SBK_QRHIGRAPHICSPIPELINE_COMPAREOP_IDX                   = 612,
    SBK_QRHIGRAPHICSPIPELINE_STENCILOP_IDX                   = 622,
    SBK_QRHIGRAPHICSPIPELINE_POLYGONMODE_IDX                 = 620,
    SBK_QRHIGRAPHICSPIPELINE_IDX                             = 604,
    SBK_QRHIGRAPHICSPIPELINE_STENCILOPSTATE_IDX              = 624,
    SBK_QRHIGRAPHICSPIPELINE_TARGETBLEND_IDX                 = 626,
    SBK_QRHIINITPARAMS_IDX                                   = 630,
...
enum : int {
    ...
    SBK_QRhiD3D11InitParams_IDX                              = 293,
    SBK_QRhiD3D11NativeHandles_IDX                           = 294,
    SBK_QRhiD3D12InitParams_IDX                              = 295,
    SBK_QRhiD3D12NativeHandles_IDX                           = 296,
    SBK_QRhiDepthStencilClearValue_IDX                       = 297,
    SBK_QRhiDriverInfo_DeviceType_IDX                        = 299,
    SBK_QRhiDriverInfo_IDX                                   = 298,
    SBK_QRhiGles2InitParams_IDX                              = 300,
    SBK_QRhiGles2NativeHandles_IDX                           = 301,
    SBK_QRhiGraphicsPipeline_Flag_IDX                        = 308,
    SBK_QFlags_QRhiGraphicsPipeline_Flag_IDX                 = 100,
    SBK_QRhiGraphicsPipeline_Topology_IDX                    = 314,
    SBK_QRhiGraphicsPipeline_CullMode_IDX                    = 307,
    SBK_QRhiGraphicsPipeline_FrontFace_IDX                   = 309,
    SBK_QRhiGraphicsPipeline_ColorMaskComponent_IDX          = 305,
    SBK_QFlags_QRhiGraphicsPipeline_ColorMaskComponent_IDX   = 99,
    SBK_QRhiGraphicsPipeline_BlendFactor_IDX                 = 303,
    SBK_QRhiGraphicsPipeline_BlendOp_IDX                     = 304,
    SBK_QRhiGraphicsPipeline_CompareOp_IDX                   = 306,
    SBK_QRhiGraphicsPipeline_StencilOp_IDX                   = 311,
    SBK_QRhiGraphicsPipeline_PolygonMode_IDX                 = 310,
    SBK_QRhiGraphicsPipeline_IDX                             = 302,
    SBK_QRhiGraphicsPipeline_StencilOpState_IDX              = 312,
    SBK_QRhiGraphicsPipeline_TargetBlend_IDX                 = 313,
    SBK_QRhiInitParams_IDX                                   = 315,
