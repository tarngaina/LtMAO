...
class BINHelper:
    ...
    read_value_dict = {
        ...
        BINType.String:     lambda bs: bs.read_utf8_sized16()[0],
    ...
    write_value_dict = {
        ...
        BINType.String:         lambda bs, value: (bs.write_utf8_sized16(value), len(value.encode('utf-8'))+2),
    ...
    def read(self, path, raw=None):
        with self.stream(path, 'rb', raw) as bs:
            ...
            if self.version >= 2:
                ...
                self.links = [bs.read_utf8_sized16()[0] for i in range(link_count)]
            # entry_types + entries
            ...
            if self.is_patch and self.version >= 3:
                ...
                for patch in self.patches:
                    ...
                    patch.path, = bs.read_utf8_sized16()
        ...
        with self.stream(path, 'wb', raw) as bs:
            ...
            if self.is_patch:
                ...
                for patch in self.patches:
                    ...
                    bs.write_utf8_sized16(patch.path)
